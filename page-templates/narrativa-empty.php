						...
						<div id="accordion">
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingOne">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
						          Terror
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingTwo">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
						          Aventura y Humor
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingThree">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
						          Ciencia Ficción
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingFour">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
						          Curiosa Vida Animal
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingFive">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
						          Mundo Médico
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingSix">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
						          Mundo Neurótico
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingSeven">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg collapsed" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
						          Absurdo
						        </button>
						      </h5>
						    </div>
						...
						<div id="accordion-novelas">
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="novelasOne">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg" data-toggle="collapse" data-target="#collapseNovelasOne" aria-expanded="true" aria-controls="collapseNovelasOne">
						          Infanto-Juveniles
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="novelasTwo">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg" data-toggle="collapse" data-target="#collapseNovelasTwo" aria-expanded="true" aria-controls="collapseNovelasTwo">
						          Género Negro
						        </button>
						      </h5>
						    </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="novelasThree">
						      <h5 class="mb-0">
						        <button class="btn btn-outline-narrativa btn-block btn-lg" data-toggle="collapse" data-target="#collapseNovelasThree" aria-expanded="true" aria-controls="collapseNovelasThree">
						          Absurdo
						        </button>
						      </h5>
						    </div>
